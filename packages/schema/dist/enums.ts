...
export type CardTypeCode = "buzzCharacter" | "character" | "oshiCharacter" | "supportCheer" | "supportEvent" | "supportEventLimited" | "supportFan" | "supportItem" | "supportItemLimited" | "supportMascot" | "supportStaffLimited" | "supportTool" | "unknown";
...
export const CARD_TYPES: readonly CardTypeCode[] = ["buzzCharacter", "character", "oshiCharacter", "supportCheer", "supportEvent", "supportEventLimited", "supportFan", "supportItem", "supportItemLimited", "supportMascot", "supportStaffLimited", "supportTool", "unknown"] as const;
...
export const MAIN_CARD_TYPES: readonly CardTypeCode[] = ["buzzCharacter", "character", "supportEvent", "supportEventLimited", "supportFan", "supportItem", "supportItemLimited", "supportMascot", "supportStaffLimited", "supportTool"] as const;
